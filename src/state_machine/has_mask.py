...
class HasMask(smach.State):
    def __init__(self):
        ...
        super().__init__(outcomes=["one_no_masked", "nobody_here", "preempted","kitchen","joke","goodbye"],
        ...
        self._keyword_subscriber = rospy.Subscriber(
            "/keyword", String, self._keyword_callback, queue_size=10
        )
    ...
    def execute(self, userdata: smach.UserData):
        ...
        if userdata.conversation_started == False:
        ...
        while not self._keywords:
            ...
            if self._everybody_masked == False:
                return "one_no_masked"
